  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-slate-900">Data Quality Assessment</h2>
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 md:grid-cols-2">
        <section className="space-y-3 rounded-lg border bg-white p-4 text-sm">
          <h3 className="text-sm font-semibold text-slate-800">Demographics & clinical</h3>
        ...
        <section className="space-y-3 rounded-lg border bg-white p-4 text-sm">
          <h3 className="text-sm font-semibold text-slate-800">Medications, allergies & vitals</h3>
          <div className="space-y-2">
            <div>
              <label className="mb-1 block text-slate-700">
      ...
      {result && (
        <section className="space-y-4 rounded-lg border bg-white p-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 className="text-sm font-semibold text-slate-800">Overall score</h3>
